...
// Simple dashboard for: App Name, iOS Rating, Android Rating, Customer Sentiment (last 7 days)

const METRICS_URL = "app-metrics.json"; // static file in repo
...
// Inject styles specifically for this dashboard to avoid conflicts
function injectCustomerSentimentStyles() {
  ...
  style.textContent = `
    ...
    .cs-subtitle{margin:2px 0 0;font-size:.8rem;color:#9ca3af;}
    .cs-controls{display:flex;gap:.5rem;flex-wrap:wrap;font-size:.75rem;}
    .cs-pill{border-radius:999px;padding:4px 10px;border:1px solid #1f2937;
      background:rgba(15,23,42,.7);color:#9ca3af;display:inline-flex;align-items:center;gap:6px;}
    .cs-pill strong{color:#e5e7eb;}
    .cs-pill select{background:transparent;border:none;color:#38bdf8;
      font-size:.75rem;outline:none;}
    .cs-layout{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,.9fr);gap:.75rem;}
    @media(max-width:900px){.cs-layout{grid-template-columns:1fr;}}
    .cs-card{background:rgba(15,23,42,.95);border-radius:14px;border:1px solid #1f2937;
      padding:.75rem;box-shadow:0 14px 30px rgba(15,23,42,.8);}
    ...
    .cs-card-header span{font-size:.75rem;color:#9ca3af;}
    .cs-table-wrap{overflow-x:auto;}
    .cs-table{width:100%;border-collapse:collapse;font-size:.75rem;}
    .cs-table th,.cs-table td{padding:6px 6px;border-bottom:1px solid #1f2937;white-space:nowrap;}
    .cs-table th{text-align:left;color:#9ca3af;font-weight:500;background:#020617;}
    .cs-table tbody tr{cursor:pointer;}
    .cs-table tbody tr:hover{background:rgba(15,23,42,.8);}
    .cs-row-active{background:rgba(15,23,42,1);}
    .cs-app-name{font-weight:500;color:#e5e7eb;}
    .cs-badge-rating{display:inline-flex;align-items:center;gap:4px;font-size:.75rem;
      padding:3px 7px;border-radius:999px;background:rgba(15,23,42,.9);border:1px solid #1f2937;}
    .cs-badge-rating .value{color:#e5e7eb;}
    .delta-up{color:#4ade80;}
    .delta-down{color:#f97373;}
    .delta-flat{color:#9ca3af;}
    .cs-pill-sentiment{display:inline-flex;align-items:center;gap:4px;padding:3px 7px;
      font-size:.75rem;border-radius:999px;border:1px solid #1f2937;}
    .sent-good{background:rgba(74,222,128,.15);color:#4ade80;border-color:rgba(74,222,128,.6);}
    .sent-bad{background:rgba(248,113,113,.15);color:#f97373;border-color:rgba(248,113,113,.6);}
    .sent-neutral{background:rgba(250,204,21,.15);color:#facc15;border-color:rgba(250,204,21,.7);}
    .cs-details-empty{font-size:.8rem;color:#9ca3af;padding:.5rem;}
    ...
    .cs-details-header p{margin:2px 0 0;font-size:.75rem;color:#9ca3af;}
    .cs-chip{border-radius:999px;border:1px solid #1f2937;padding:3px 8px;font-size:.72rem;
      display:inline-flex;align-items:center;gap:4px;}
    .cs-chip .dot{width:6px;height:6px;border-radius:999px;background:#38bdf8;
      box-shadow:0 0 10px rgba(56,189,248,.8);}
    .cs-metrics-row{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.5rem;
      margin-bottom:.5rem;font-size:.75rem;}
    @media(max-width:800px){.cs-metrics-row{grid-template-columns:1fr;}}
    .metric-card{border-radius:10px;padding:8px;border:1px solid #1f2937;background:#020617;}
    .metric-label{color:#9ca3af;margin-bottom:3px;}
    .metric-value{display:flex;align-items:baseline;gap:6px;font-size:.9rem;font-weight:500;}
    .metric-sub{margin-top:2px;font-size:.7rem;color:#9ca3af;}
    ...
    .list-card{border-radius:10px;border:1px solid #1f2937;background:#020617;padding:7px 8px;
      font-size:.75rem;}
    .list-block{margin-bottom:.5rem;}
    .list-header{display:flex;justify-content:space-between;margin-bottom:2px;}
    .list-header span{font-size:.7rem;color:#9ca3af;}
    .comment-list{list-style:none;padding:0;margin:0;max-height:140px;overflow-y:auto;}
    .comment-item{padding:4px 0;border-bottom:1px dashed #1f2937;}
    .comment-text{font-size:.74rem;}
    .comment-meta{margin-top:2px;display:flex;justify-content:space-between;font-size:.68rem;color:#9ca3af;}
    ...
    .driver-trend{font-size:.7rem;padding:2px 6px;border-radius:999px;}
    .trend-improving{background:rgba(74,222,128,.15);color:#4ade80;border:1px solid rgba(74,222,128,.6);}
    .trend-worsening{background:rgba(248,113,113,.15);color:#f97373;border:1px solid rgba(248,113,113,.6);}
    .trend-steady{background:rgba(56,189,248,.12);color:#38bdf8;border:1px solid rgba(56,189,248,.6);}
  `;
